...
- **[HYDRA-UMC-DSI](https://github.com/JuanenRac/HYDRA-UMC-DSI)** — pianificato: una UI touch nativa per il touchscreen DSI da 7" (1280×800) proprio di HYDRA-UMC sulla Compute Module 5, che controlla direttamente dalla scheda questo stesso server. Non ancora iniziato.
