...
- **[HYDRA-UMC-DSI](https://github.com/JuanenRac/HYDRA-UMC-DSI)** — pianificato: una UI touch nativa per il touchscreen DSI da 5"/7" (1280×720, stessa risoluzione in entrambe le dimensioni) proprio di HYDRA-UMC sulla Compute Module 5, che controlla direttamente dalla scheda questo stesso server. Non ancora iniziato.
